...
const projectData = {
  ...
  map: {
    number: "BUILD / 002",
    type: "PRIVATE PRODUCT · TBA",
    kicker: "CURRENTLY IN DEVELOPMENT",
    title: "Upcoming Product",
    description: "A new discovery-focused product is being built quietly behind the scenes. More will be shared when it is ready.",
    outcome: "The concept, interface, and launch details are intentionally private for now.",
    stack: "Product strategy, full-stack development, and a little patience.",
    mark: "TBA",
    theme: "theme-map",
    media: null,
    links: [],
  ...
  weightlisted: {
    ...
    outcome: "Founded the business, led a three-person team, shaped the brand and pricing, acquired clients, and shipped production websites.",
